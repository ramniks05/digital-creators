    ...
    <div class="footer-main-grid mb-10 md:mb-12">
      ...
      <div class="footer-brand-panel">
        ...
        <div class="footer-social-row">
          ...
          <a href="https://twitter.com/digitalcreatorss" target="_blank" rel="noopener noreferrer"
            aria-label="Twitter" class="footer-social-advanced group/social">
            <span class="icon-advanced icon-advanced-sm">
              <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
            </span>
          </a>
          <a href="https://instagram.com/digitalcreatorss" target="_blank" rel="noopener noreferrer"
